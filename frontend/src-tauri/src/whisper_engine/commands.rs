...
use crate::whisper_engine::whisper_engine::{validate_whisper_model_file, whisper_model_source};
                ...
                Ok(metadata) => {
                    ...
                    if file_size_mb >= 1 {
                        let expected_sha256 = whisper_model_source(name)
                            ...
                            .1;
                        if validate_whisper_model_file(&model_path, expected_sha256)
                            .await
                            .is_ok()
                        {
                            ...
                            ModelStatus::Corrupted {
                                ...
                                expected_min_size: (size_mb as u64 * 1024 * 1024 * 9) / 10,
                            }
                        }
                    } else {
                        ModelStatus::Missing
