...
/// * `app_data_dir` - Optional legacy provider data directory
...
// The orchestration boundary keeps the established summary inputs explicit.
...
pub async fn generate_meeting_summary(
        ...
        resolve_cached_english(cached_english, summary_language)
    {
        ...
        // Use multi-level chunking for the explicit Ollama provider with long transcripts.
