#!/bin/bash
# GPU-accelerated development script for gcrdings
...
echo -e "${BLUE}🚀 gcrdings GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting gcrdings in development mode...${NC}"
echo ""
