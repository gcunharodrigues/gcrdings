...
export interface PrincipalRecordParticipant {
  id: string;
  display_name: string;
  speaker_cluster_id?: string;
}
...
export interface SessionRecord {
  ...
  participants: PrincipalRecordParticipant[];
  transcripts: Transcript[];
}

export interface DiarizationModelStatus {
  state: 'missing' | 'corrupted' | 'available' | 'unsupported';
...
export interface SaveSessionRecordReceipt {
