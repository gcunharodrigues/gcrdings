...
interface RecordingControlsProps {
  ...
  sourceStatuses: {
    microphone: 'waiting' | 'storing' | 'lost' | 'failed';
    systemAudio: 'waiting' | 'storing' | 'lost' | 'failed';
  };
            ...
            <>
              {showPlayback ? (
                ...
                <>
                  ...
                  <div className="flex items-center gap-3 mx-4 text-[10px] text-gray-600">
                    {[
                      ['Mic', audioLevels.microphone, sourceStatuses.microphone, selectedDevices?.micDevice !== DISABLED_AUDIO_SOURCE],
                      ['System', audioLevels.systemAudio, sourceStatuses.systemAudio, selectedDevices?.systemDevice !== DISABLED_AUDIO_SOURCE],
