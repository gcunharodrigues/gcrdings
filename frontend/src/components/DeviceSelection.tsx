...
export function DeviceSelection({ selectedDevices, onDeviceChange, disabled = false }: DeviceSelectionProps) {
  ...
  const fetchDevices = async () => {
    try {
      ...
      setDevices(result);
      log.debug('Fetched audio devices:', result);
    } catch (err) {
  ...
  const startAudioLevelMonitoring = async () => {
    try {
      ...
      setShowLevels(true);
      log.debug('Started audio level monitoring for input devices:', deviceNames);
    } catch (err) {
  ...
  const stopAudioLevelMonitoring = async () => {
    try {
      ...
      log.debug('Stopped audio level monitoring');
    } catch (err) {
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value={DISABLED_AUDIO_SOURCE}>Do not record microphone</SelectItem>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value={DISABLED_AUDIO_SOURCE}>Do not record system audio</SelectItem>
