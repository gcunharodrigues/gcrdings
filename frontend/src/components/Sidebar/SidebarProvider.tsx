...
interface SidebarContextType {
  ...
  setHasUnsavedReviewChanges: (dirty: boolean) => void;
  navigate: (path: string, bypassGuard?: boolean) => boolean;
...
export function SidebarProvider({ children }: { children: React.ReactNode }) {
  ...
  const setHasUnsavedReviewChanges = React.useCallback((dirty: boolean) => {
    hasUnsavedReviewChangesRef.current = dirty;
  }, []);
