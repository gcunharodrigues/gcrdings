        ...
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                ...
                <p className="text-medium text-gray-600 mt-1">
                    Private recordings and verifiable records that stay under your control.
                </p>
            </div>

            {/* Features Grid - Compact */}
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">What makes gcrdings different</h2>
                <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                        <h3 className="font-bold text-sm text-gray-900 mb-1">Privacy-first</h3>
                        <p className="text-xs text-gray-600 leading-relaxed">Capture and transcription stay local by default. External summaries run only with a provider you configure.</p>
                    </div>
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
