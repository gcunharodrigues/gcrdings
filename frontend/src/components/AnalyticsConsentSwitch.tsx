  ...
  const performToggle = async (enabled: boolean) => {
    ...
    try {
      ...
      if (enabled) {
        ...
        log.debug('Analytics re-enabled successfully');
      } else {
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-2 p-2 bg-blue-50 rounded border border-blue-200">
          ...
          <div className="text-xs text-blue-700">
            <p className="mb-1">
              Your recordings, transcripts, and verifiable records remain completely private and local.
            </p>
            <p>
              See <code>PRIVACY_POLICY.md</code> in the application source for the full policy.
            </p>
          </div>
        </div>
      </div>
