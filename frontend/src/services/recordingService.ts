...
export interface RecordingState {
  ...
  microphone_status: 'waiting' | 'storing' | 'lost' | 'failed';
  system_audio_status: 'waiting' | 'storing' | 'lost' | 'failed';
}
...
export const DISABLED_AUDIO_SOURCE = '__disabled__';
const DEFAULT_MICROPHONE = '__default_microphone__';
const DEFAULT_SYSTEM_AUDIO = '__default_system_audio__';
...
export class RecordingService {
  ...
  async startRecordingWithDevices(
    ...
    return invoke('start_recording_with_devices_and_meeting', {
      mic_device_name: micDeviceName ?? DEFAULT_MICROPHONE,
      system_device_name: systemDeviceName ?? DEFAULT_SYSTEM_AUDIO,
